...
const tabContent: Record<ResidentTab, ReactElement> = {
...
export function ResidentPortalPage() {
  ...
  const activeTab: ResidentTab = VALID_TABS.includes(tab as ResidentTab)
    ? (tab as ResidentTab)
    : 'requests'
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <LoadingOverlay isVisible={isLoggingOut} message="Signing out..." fullscreen />
      ...
      <header className="sticky top-0 z-30 flex items-center justify-between border-b border-slate-200 bg-white/90 px-6 py-3 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/90">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-rose-200 bg-rose-50 px-3 py-1.5 text-xs font-medium text-rose-700 transition hover:bg-rose-100 dark:border-rose-900/60 dark:bg-rose-950/30 dark:text-rose-300 dark:hover:bg-rose-900/40"
          >
